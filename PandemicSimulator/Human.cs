...
namespace PandemicSimulator
{
    public class Human
    {
        ...
        public static double GLOBAL_HYGIENE;
        public static double GLOBAL_SOCIAL_DISTANCE;
        public static double GLOBAL_TRAVELLING_RATE;
        ...
        {
            if (0f <= hygiene && hygiene <= 1f && 0f <= socialDistance && socialDistance <= 1f && 0f <= travellingRate && travellingRate <= 1f)
            {
            ...
            {
                throw new Exception("Human constucteur > Merci de bien mettre des parametres compris entre 0f et 1f");
            }
